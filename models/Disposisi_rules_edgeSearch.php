...
/**
 * Disposisi_rules_edgeSearch represents the model behind the search form of `app\models\DisposisiRulesEdge`.
 */
class Disposisi_rules_edgeSearch extends DisposisiRulesEdge
{
    /**
     * {@inheritdoc}
     */

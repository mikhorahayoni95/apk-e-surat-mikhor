...
/**
 * Approval_surat_keluarSearch represents the model behind the search form of `app\models\ApprovalSuratKeluar`.
 */
class Approval_surat_keluarSearch extends ApprovalSuratKeluar
{
    /**
     * {@inheritdoc}
     */

...
/**
 * Disposisi_surat_masukSearch represents the model behind the search form of `app\models\DisposisiSuratMasuk`.
 */
class Disposisi_surat_masukSearch extends DisposisiSuratMasuk
{
    /**
     * {@inheritdoc}
     */

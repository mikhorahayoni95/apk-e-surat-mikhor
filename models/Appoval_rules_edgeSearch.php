...
/**
 * Appoval_rules_edgeSearch represents the model behind the search form of `app\models\ApprovalRulesEdge`.
 */
class Appoval_rules_edgeSearch extends ApprovalRulesEdge
{
    /**
     * {@inheritdoc}
     */
